...
<main>
			...
			<div class="plates-section">
				<div class="container">
					...
					<div class="row">
						<div class="col-12"><a target="_blank" href="http://en.woodmosaica.com/catalog/collection_ELEGANT.pdf" class="btn-wide download green">Download the Catalogue</a></div>
					</div>
				</div>
			</div>
