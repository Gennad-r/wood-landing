...
<head>
	...
	<?php wp_head(); ?>
	<meta name="google-site-verification" content="kFdnZA3BtXajJcOWeVcnRJXQaDSof8S4vtqCSNSAn7w" />
</head>
			...
			<div class="container mb-4">
				<div class="row mt-3">
					<div class="logo-holder col-auto">
						<img src="<?php echo get_template_directory_uri() . '/app/img/logo-wood.svg' ?>" alt="logo" class="img-responsive">
					</div>
				...
				<?php
					$defaults = array(
						...
						'menu' => 'Primary menu',
						'container' => 'nav',
						'container_class' => 'menu col-lg-auto main-page',
