					...
					<div class="row">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="dim-img-holder">
								<img src="<?php the_field('dimensions_image', $el['taxonomy'] . '_' . $el['term_id']) ?>" alt="" class="img-responsive">
								<div class="dim-size"><?php echo $el['name'] ?></div>
							</div>
							<p><?php echo $el['description'] ?></p>
						</div> <!-- plate -->
						<?php endforeach ?>
